...
$sql =mysqli_query($con,"SELECT AdminUserName,AdminEmailId,AdminPassword FROM "
        . "tbladmin WHERE (AdminUserName='$uname' || AdminEmailId='$uname')");
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Assigment 2 | Admin Panel</title>
